class Form{
    ...
    display(){
        ...
        this.next1.position(displayWidth/2+900,700);
        this.next1.style('background','lightGreen');
        this.next2.position(displayWidth/2+900,700);
        this.next2.style('background','lightGreen');
        this.next3.position(displayWidth/2+900,700);
        this.next3.style('background','lightGreen');
        this.next4.position(displayWidth/2+900,700);
        this.next4.style('background','lightGreen');
        this.next5.position(displayWidth/2+900,700);
        this.next5.style('background','lightGreen');
        this.next6.position(displayWidth/2+900,700);
        this.next6.style('background','lightGreen');
        this.next7.position(displayWidth/2+900,700);
        this.next7.style('background','lightGreen');
        this.next8.position(displayWidth/2+900,700);
        this.next8.style('background','lightGreen');
        this.next9.position(displayWidth/2+900,700);
        this.next9.style('background','lightGreen');
        this.next10.position(displayWidth/2+900,700);
        this.next10.style('background','lightGreen');
        this.next11.position(displayWidth/2+900,700);
        this.next11.style('background','lightGreen');
        this.next12.position(displayWidth/2+900,700);
        this.next12.style('background','lightGreen');
        this.next13.position(displayWidth/2+900,700);
        this.next13.style('background','lightGreen');
        this.next14.position(displayWidth/2+900,700);
        this.next14.style('background','lightGreen');
        this.next15.position(displayWidth/2+900,700);
